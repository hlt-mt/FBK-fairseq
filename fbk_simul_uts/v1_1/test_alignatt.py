...
from examples.speech_to_text.simultaneous_translation.agents.v1_1.simul_offline_alignatt import AlignAttSTAgent
from fbk_simul_uts.v1_1.test_base_simulst_agent import BaseSTAgentTestCaseV2, MockedLoadModelVocab


class AlignAttSimulSTPolicyTestCase(BaseSTAgentTestCaseV2, unittest.TestCase):
    ...
    @patch('examples.speech_to_text.simultaneous_translation.agents.v1_1.'
           'simul_offline_alignatt.AlignAttSTAgent.load_model_vocab', MockedLoadModelVocab.load_model_vocab)
    @patch('examples.speech_to_text.simultaneous_translation.agents.v1_1.'
    ...
    def test_first_two_tokens_not_aligned_to_banned_frames(self, get_hypo_and_prefix):
        ...
        action = AlignAttSTAgent._policy(self.agent, self.states)
    ...
    def test_no_token_emitted(self, get_hypo_and_prefix):
        ...
        # prefix len 0
        get_hypo_and_prefix.return_value = hypo, 0
        self.assertIsInstance(AlignAttSTAgent._policy(self.agent, self.states), ReadAction)
    ...
    def test_multilingual_emission(self, get_hypo_and_prefix):
        hypo = {
            "tokens": torch.tensor([1, 4, 5, 6, 7, 0]),
            "attention": torch.tensor([
