...
@register_explanation_task("generic")
class GenericExplanationTask(ExplanationTask):
    """
    The goal of this task is to explain the model's prediction for every token 
