...
class OcclusionTransformerDecoderScriptable(TransformerDecoderScriptable):
    ...
    def extract_features_scriptable(
        ...
        Args:
            ...
            - occlusion_masks: masks to occlude target embeddings,
                if not defined new masks will be generated by the perturbator.
            - last_tokens_to_perturb: if provided, tokens after these positions 
        ...
        return x, {"masks": occlusion_masks, "attn": [attn], "inner_states": inner_states}
    ...
    def forward(
        ...
        Args:
            ...
            full_context_alignment (bool, optional): don't apply
                auto-regressive mask to self-attention (default: False).
            occulsion_masks (Tensor, optional): masks to occlude target embeddings, 
                if not defined new masks will be generated by the perturbator.
            last_tokens_to_perturb: if provided, tokens after these positions 
                will not be occluded. This is useful when explaining only a specific word
                in each sentence, so tokens that are part of this word are not occluded,
