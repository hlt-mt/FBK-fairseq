...
class S2TTransformerModel(FairseqEncoderDecoderModel, EncoderPretrainingSupport):
...
@register_model_architecture("s2t_transformer_fbk", "s2t_transformer_sp_fbk")
def s2t_transformer_sp(args):
    args.encoder_layers = getattr(args, "encoder_layers", 16)
    s2t_transformer_s(args)


@register_model_architecture("s2t_transformer_fbk", "s2t_transformer_m_fbk")
...
@register_model_architecture("s2t_transformer_fbk", "s2t_transformer_mp_fbk")
def s2t_transformer_mp(args):
    args.encoder_layers = getattr(args, "encoder_layers", 16)
    s2t_transformer_m(args)


@register_model_architecture("s2t_transformer_fbk", "s2t_transformer_l_fbk")
...
@register_model_architecture("s2t_transformer_fbk", "s2t_transformer_lp_fbk")
